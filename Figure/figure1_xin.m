...
load pc_q.mat
load mso_q.mat
load D:\program\mars\crust\model_zhong_maven\qd
...
set(gca,'yminortick','on');
 ...
 %set(h_2,'Ytick',[0.5 1 1.5 ] ,'YTicklabel',{'0.5','1' ,'1.5'});
  ...
  xlabel('Latitude (°)','fontsize',15);
   text(-40,55,'(c)','fontsize',15)
   % text(100,5,'MGS+MAVEN','fontsize',10)
    title('Model data set','fontsize',15)
      xlim([1 180])
    set(gca,'tickdir','out')
   set(gca,'xminortick','on');
set(gca,'yminortick','on');
...
set(gca,'yminortick','on');    grid on;
   ...
   %%
    ...
    set(gcf,'PaperPositionMode','manual','PaperUnits','centimeters',...
       ...
       print('-dtiff ','-r600',['C:\Users\gao\Desktop\f1.tiff']);
       print('-depsc ','-r600',['C:\Users\gao\Desktop\f1.eps']);
